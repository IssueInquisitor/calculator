...
public class Input {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Выполняются операции: сложение'+', вычитание '-', умножение '*', деление'/'.");
...
// division Roman
            ...
            default: throw new IOException("throws Exception");
        }
    }
}